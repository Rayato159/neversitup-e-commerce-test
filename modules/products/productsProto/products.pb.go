...
func (x *ProductArr) Reset() {
	*x = ProductArr{}
	if protoimpl.UnsafeEnabled {
		mi := &file_modules_products_productsProto_products_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ProductArr) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductArr) ProtoMessage() {}

func (x *ProductArr) ProtoReflect() protoreflect.Message {
	mi := &file_modules_products_productsProto_products_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductArr.ProtoReflect.Descriptor instead.
func (*ProductArr) Descriptor() ([]byte, []int) {
	return file_modules_products_productsProto_products_proto_rawDescGZIP(), []int{2}
}

func (x *ProductArr) GetProducts() []*Product {
	if x != nil {
		return x.Products
	}
	return nil
...
var file_modules_products_productsProto_products_proto_rawDesc = []byte{
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x01, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0x32, 0x0a,
	0x0a, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x41, 0x72, 0x72, 0x12, 0x24, 0x0a, 0x08, 0x70,
	...
	0x73, 0x32, 0x49, 0x0a, 0x10, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x35, 0x0a, 0x0e, 0x46, 0x69, 0x6e, 0x64, 0x4f, 0x6e, 0x65,
	0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x12, 0x12, 0x2e, 0x46, 0x69, 0x6e, 0x64, 0x4f, 0x6e,
	0x65, 0x50, 0x72, 0x6f, 0x64, 0x63, 0x75, 0x74, 0x52, 0x65, 0x71, 0x1a, 0x0b, 0x2e, 0x50, 0x72,
	0x6f, 0x64, 0x75, 0x63, 0x74, 0x41, 0x72, 0x72, 0x22, 0x00, 0x28, 0x01, 0x42, 0x32, 0x5a, 0x30,
...
var file_modules_products_productsProto_products_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_modules_products_productsProto_products_proto_goTypes = []interface{}{
	...
	(*ProductArr)(nil),        // 2: ProductArr
}
var file_modules_products_productsProto_products_proto_depIdxs = []int32{
	1, // 0: ProductArr.products:type_name -> Product
	0, // 1: ProductsServices.FindOneProduct:input_type -> FindOneProdcutReq
	2, // 2: ProductsServices.FindOneProduct:output_type -> ProductArr
...
func file_modules_products_productsProto_products_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_modules_products_productsProto_products_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProductArr); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
